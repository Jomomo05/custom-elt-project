...
3. Navigate to the repository directory and run `docker compose up`. To load updated files run `docker compose up --build`
...
6. API endpoints are set up on http://localhost:8000/actors